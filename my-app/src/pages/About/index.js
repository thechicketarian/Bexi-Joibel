...
function About(){
    return(
        ...
        <h2> about me. </h2> 
        <p>  Buenas, my name is Bexi Joibel, I am a Designer and Front-End Developer originally from Panamá currently living in Memphis, TN. I love to work in all aspects of web development and design, but ultimately obsess over front-end, UI/UX design, illustration and product design.
<br></br> <br></br>
